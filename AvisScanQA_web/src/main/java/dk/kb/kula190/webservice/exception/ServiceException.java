...
public class ServiceException extends WebApplicationException {
     ...
     */
    public ServiceException(MediaType mimeType, Object entity, Response.Status responseStatus) {
        super();
        this.responseStatus = responseStatus;
     ...
     * @param responseStatus HTTP response code.
     */
    public ServiceException(MediaType mimeType, Object entity, Throwable cause, Response.Status responseStatus) {
        super(cause);
        this.responseStatus = responseStatus;
        this.mimeType       = mimeType;
        this.entity         = entity;
